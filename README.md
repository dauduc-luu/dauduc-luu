...
* AI Systems with Hardware Integration

## Featured Projects

### Autonomous Attendance Robot
...
* Camera video streaming from Raspberry Pi
* Face detection and recognition on laptop
* Automatic attendance logging
* ROS2/Nav2-based robot navigation
* Lidar-based mapping and obstacle avoidance
* Attendance data export and management
...
I am building a practical AI and Robotics portfolio through real-world projects, with a focus on computer vision, autonomous systems and intelligent classification applications.
